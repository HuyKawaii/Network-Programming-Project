...
Board::Board() : display(this, nullptr) { 
	initializeVars();
	emptyBoard();
	initializePieces();
	placePiecesDefault();	
...
Board::Board(ClientSocket * socket) : display(this, socket) { 
  socketPtr = socket;
	socketPtr->setBoardPtr(this);
	initializeVars();
	emptyBoard();
	initializePieces();
	placePiecesDefault();	
...
Board::Board(std::string FEN, ClientSocket * socket) : display(this, socket) {
  socketPtr = socket;
	socketPtr->setBoardPtr(this);
